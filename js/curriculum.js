const CURRICULUM = {
  ...
  "4": {
    ...
    "progressives": [
      ...
      },
      {
        "index": 6,
        "code": "g4_geometry",
        "name": "Angles & Symmetry",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 7,
        "code": "g4_word",
        "name": "Word Problems (Whole Numbers / Fractions)",
        "generator": "buildGenericMixedQuestion"
      }
    ]
  },
  ...
  "5": {
    ...
    "progressives": [
      ...
      },
      {
        "index": 7,
        "code": "g5_word",
        "name": "Word Problems (Ratio / Percent / Volume)",
        "generator": "buildGenericMixedQuestion"
      }
    ]
  },
  ...
  "6": {
    ...
    "progressives": [
      ...
      },
      {
        "index": 2,
        "code": "g6_eq_one_step",
        "name": "Equations (One-Step & Two-Step)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 3,
        "code": "g6_ratio_rate_speed",
      ...
      },
      {
        "index": 5,
        "code": "g6_area_volume",
        "name": "Area & Volume (Advanced)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 6,
        "code": "g6_geometry",
        "name": "Geometry (Angles, Triangles, Nets)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 7,
  ...
  "7": {
    ...
    "progressives": [
      ...
      {
        "index": 3,
        "code": "g7_ratio_percent",
        "name": "Ratio, Rate & Percent",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 4,
        "code": "g7_geom",
        "name": "Geometry (Angles, Triangles, Area)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 5,
        "code": "g7_pythagoras",
        "name": "Pythagorean Theorem (Intro)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 6,
        "code": "g7_graphs_functions",
        "name": "Graphs & Functions (Intro)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 7,
  ...
  "8": {
    ...
    "progressives": [
      ...
      },
      {
        "index": 4,
        "code": "g8_pythagoras",
        "name": "Pythagorean Theorem (Applications)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 5,
      ...
      },
      {
        "index": 7,
        "code": "g8_word",
        "name": "Word Problems (Functions / Geometry)",
        "generator": "buildGenericMixedQuestion"
      }
    ]
  },
  ...
  "9": {
    ...
    "progressives": [
      ...
      },
      {
        "index": 2,
        "code": "g9_lin_graphs",
        "name": "Linear Graphs & Slope-Intercept Form",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 3,
      ...
      },
      {
        "index": 4,
        "code": "g9_poly",
        "name": "Polynomials (Add/Sub/Multiply)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 5,
        "code": "g9_factoring",
        "name": "Factoring (Trinomials & Special)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 6,
      ...
      },
      {
        "index": 7,
        "code": "g9_quad_graph",
        "name": "Quadratic Functions & Graphs",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 8,
        "code": "g9_word",
        "name": "Algebra I Word Problems",
        "generator": "buildGenericMixedQuestion"
      }
    ]
  },
  ...
  "10": {
    ...
    "progressives": [
      ...
      },
      {
        "index": 2,
        "code": "g10_triangles",
        "name": "Triangles (Angle Sum / Properties)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 3,
        "code": "g10_circles",
        "name": "Circles (Arcs / Angles)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 4,
      ...
      },
      {
        "index": 6,
        "code": "g10_transform",
        "name": "Transformations (Rigid & Dilations)",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 7,
  ...
  "12": {
    ...
    "progressives": [
      ...
      {
        "index": 3,
        "code": "g12_trig_graphs",
        "name": "Trig Graphs & Transformations",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 4,
        "code": "g12_matrix_vector",
      ...
      {
        "index": 7,
        "code": "g12_precalc_mix",
        "name": "Mixed Precalculus Review",
        "generator": "buildGenericMixedQuestion"
      },
      {
        "index": 8,
        "code": "g12_hs_mix",
        "name": "High School Mixed Review (9–12)",
        "generator": "buildGenericMixedQuestion"
      }
    ]
  }
